...
```sh
git clone https://github.com/davidvasadi/lazarsalon.git
cd lazarsalon
yarn
yarn run setup
```
...
Navigate to your `./lazarsalon/strapi` folder and start the server:
...
Open a new terminal tab or window to leave Strapi running, and navigate to your `./laazrsalon/next` and start the server:
