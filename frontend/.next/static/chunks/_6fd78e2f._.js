...
const HowItWorks = (param)=>{
    ...
    const iconByIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HowItWorks.useMemo[iconByIndex]": ()=>[
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$coffee$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Coffee$3e$__["Coffee"],
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$diamond$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Diamond$3e$__["Diamond"],
        ...
        "HowItWorks.useMemo[resolvedSteps]": ()=>{
            ...
            return src.map({
                "HowItWorks.useMemo[resolvedSteps]": (s, i)=>{
                    ...
                    var _s_title, _ref, _s_description, _ref1, _ctaText, _ref2, _ctaHref, _ref3, _iconByIndex_i;
                    return {
                        ...
                        icon: (_iconByIndex_i = iconByIndex[i]) !== null && _iconByIndex_i !== void 0 ? _iconByIndex_i : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$sparkles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Sparkles$3e$__["Sparkles"]
                    };
                }
            }["HowItWorks.useMemo[resolvedSteps]"]);
        }
    ...
    const animCtrlRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const [liveActive, setLiveActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const pauseAuto = function() {
        let ms = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 9000;
    ...
    const geom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HowItWorks.useMemo[geom]": ()=>{
            ...
            const nodesT = len <= 1 ? [
                ...
                "HowItWorks.useMemo[geom]": (_, i)=>{
                    const raw = len === 1 ? 0.5 : i / (len - 1);
                    return 0.08 + raw * 0.84;
                }
            }["HowItWorks.useMemo[geom]"]);
            const nodePts = nodesT.map({
                "HowItWorks.useMemo[geom].nodePts": (t)=>quad(t, p0, p1, p2)
            }["HowItWorks.useMemo[geom].nodePts"]);
            const centerX = viewportW / 2;
            const snaps = nodePts.map({
                "HowItWorks.useMemo[geom].snaps": (pt)=>centerX - pt.x
            }["HowItWorks.useMemo[geom].snaps"]);
    ...
    const stopAnim = ()=>{
        var _animCtrlRef_current;
        (_animCtrlRef_current = animCtrlRef.current) === null || _animCtrlRef_current === void 0 ? void 0 : _animCtrlRef_current.stop();
        animCtrlRef.current = null;
    };
    const snapTo = function(i) {
        let soft = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        const idx = clamp(i, 0, Math.max(0, len - 1));
        var _geom_snaps_idx;
        const target = (_geom_snaps_idx = geom.snaps[idx]) !== null && _geom_snaps_idx !== void 0 ? _geom_snaps_idx : 0;
        stopAnim();
        if (reduce) {
            x.set(target);
            return;
        }
        animCtrlRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$animation$2f$animate$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["animate"])(x, target, soft ? {
            duration: 0.28,
            ease: [
                0.22,
                1,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$utils$2f$use$2d$motion$2d$value$2d$event$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMotionValueEvent"])(x, 'change', {
    ...
    const onTrackPointerDown = (e)=>{
        ...
        const el = e.target;
        if (el === null || el === void 0 ? void 0 : el.closest('[data-milestone-node="true"]')) return;
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                style: {
                                                    top: "".concat(Math.max(0, geom.markerTop), "px"),
                                                    height: "".concat(Math.max(0, geom.markerBottom - geom.markerTop), "px"),
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                        ...
                                                        width: geom.virtualW,
                                                        height: geom.H,
                                                        viewBox: "0 0 ".concat(geom.virtualW, " ").concat(geom.H),
                                                        className: "absolute inset-0",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                                            d: "M ".concat(geom.p0.x, " ").concat(geom.p0.y, " Q ").concat(geom.p1.x, " ").concat(geom.p1.y, " ").concat(geom.p2.x, " ").concat(geom.p2.y),
                                                            fill: "none",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(activeStep.icon, {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            activeStep.ctaText && activeStep.ctaHref ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "mt-4",
...
_s(HowItWorks, "Imc5BPMvGw2hRc0faUn7/Hfwscs=", false, function() {
    return [
...
//# sourceMappingURL=_6fd78e2f._.js.map