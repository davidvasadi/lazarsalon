...
function DiamondMark() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        "aria-hidden": true,
        className: "inline-block h-4 w-4 rotate-45 rounded-[5px] shadow-[0_18px_40px_rgba(0,0,0,0.55),inset_0_0_0_1px_rgba(255,255,255,0.10)]",
        style: {
            background: 'linear-gradient(145deg, rgba(178,147,61,0.98), rgba(178,147,61,0.28))'
        }
    }, void 0, false, {
...
function Tick(param) {
    ...
    // NOTE:
    // - The ring (parent) rotates by "--dial" and by framer rotate.
    // - This tick container is placed on the circle via rotate(a) translateY(-radius).
    // - To keep the tick VERTICAL on screen, we counter-rotate the line by -(dial + a).
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        "aria-hidden": true,
...
function StepMarker(param) {
    let { angleDeg, radius, stemLen, step, index, rot, reduce, isMobile, hidden, onPick } = param;
    _s();
    const Icon = step.icon;
    // Keep stems/icons almost vertical (like reference), but leave a little residual tilt for “rotation feel”.
    // total rotation at this node is (rot + angleDeg). We cancel ~88% of it -> small lean remains.
    const counter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(rot, {
        "StepMarker.useTransform[counter]": (r)=>-(r + angleDeg) * 0.88
    }["StepMarker.useTransform[counter]"]);
    // Distance from center (0°) -> fade + slight scale back
    const rel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(rot, {
        "StepMarker.useTransform[rel]": (r)=>normDeg(r + angleDeg)
    }["StepMarker.useTransform[rel]"]);
    const depthScale = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(rel, {
        "StepMarker.useTransform[depthScale]": (v)=>{
            const a = Math.min(1, Math.abs(v) / 120);
            return 1 - a * 0.1;
        }
    }["StepMarker.useTransform[depthScale]"]);
    const depthOpacity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(rel, {
        "StepMarker.useTransform[depthOpacity]": (v)=>{
            const a = Math.min(1, Math.abs(v) / 120);
            return 1 - a * 0.38;
        }
    }["StepMarker.useTransform[depthOpacity]"]);
...
_s(StepMarker, "bgWPKr1acv2bUuIT88rAHU5EOWk=", false, function() {
    return [
...
const HowItWorks = (param)=>{
    ...
    // Fodrászat-releváns ikonok (4 step)
            ...
            return src.map({
                "HowItWorks.useMemo[resolvedSteps]": (s, i)=>{
                    ...
                    return {
                        ...
                        icon: (_iconByIndex_i = iconByIndex[i]) !== null && _iconByIndex_i !== void 0 ? _iconByIndex_i : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$scissors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Scissors$3e$__["Scissors"]
                    };
                }
            }["HowItWorks.useMemo[resolvedSteps]"]);
        }
    ...
    const geom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HowItWorks.useMemo[geom]": ()=>{
            ...
            // (panel background etc. stays untouched) — only dial geometry here
            const arcH = isMobile ? 420 : 470;
            // Circle size/radius (bigger => flatter arc)
            const radius = clamp(viewportW * (isMobile ? 0.86 : 0.78), isMobile ? 460 : 560, isMobile ? 640 : 820);
            const size = radius * 2;
            // Circle top inside the stage (controls arc vertical placement)
            const peakY = isMobile ? 132 : 148;
            // Step distribution across the arc (wide enough so neighbors are visible near the ends)
            const stepSpan = isMobile ? 210 : 230;
            ...
            // Tick distribution (wider than steps, many ticks)
            // Tick distribution (FULL circle -> a panel csak a felső ívet “ablakolja ki”)
            const tickSpan = 360;
            const tickStart = -180;
            const tickCount = isMobile ? 132 : 176;
            return {
                viewportW,
                isMobile,
                arcH,
    ...
    const pauseAuto = function() {
        let ms = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 11000;
    ...
    // live highlight: whichever is closest to center (0°)
    ...
    const displayIndex = dragging ? liveActive : safeActive;
    ...
    const DEG_PER_PX = geom.isMobile ? 0.17 : 0.14;
    const onDragStart = ()=>{
        pauseAuto(11000);
    ...
    // CSS var for “dial rotation” (used to keep ticks vertical without per-tick motion hooks)
    ...
    // Center marker geometry (only ONE gold line + ONE diamond)
    const marker = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HowItWorks.useMemo[marker]": ()=>{
            ...
            const iconY = geom.isMobile ? peak + 156 : peak + 176; // where the center icon sits
            return {
                labelY: peak - (geom.isMobile ? 46 : 50),
                diamondY: peak - (geom.isMobile ? 20 : 22),
                lineTop: peak - 2,
                lineBottom: iconY - 8,
                iconY,
                titleY: iconY + (geom.isMobile ? 30 : 32)
            };
        }
    }["HowItWorks.useMemo[marker]"], [
        geom.isMobile,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                    ...
                                                    drag: reduce ? false : 'x',
                                                    // small constraint to keep drag alive (no “freeze”), but visually we keep it invisible
                                                    dragConstraints: {
                                                        left: -320,
                                                        right: 320
                                                    },
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                    ...
                                                    style: {
                                                        ...
                                                        width: geom.size,
                                                        height: geom.size,
                                                        // ✅ ez marad meg Framer mellett is (nem “eszi meg” a transformot)
                                                        x: -geom.size / 2,
                                                        rotate: rot,
                                                        // used by ticks to counter-rotate to vertical
                                                        ['--dial']: dialCss
                                                    },
                                                    children: [
                                                        ticks.map((i)=>{
                                                            ...
                                                            // longer ticks like reference
                                                            const L = major ? geom.isMobile ? 48 : 60 : mid ? geom.isMobile ? 34 : 42 : geom.isMobile ? 20 : 24;
                                                        ...
                                                        resolvedSteps.map((s, i)=>{
                                                            const hidden = i === displayIndex;
                                                            // stems are long like reference
                                                            const stemLen = hidden ? 0 : geom.isMobile ? 108 : 126;
                                                            var _geom_stepAngles_i;
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            style: {
                                                                ...
                                                                transform: 'translateX(-1px)',
                                                                background: 'linear-gradient(to bottom, rgba(178,147,61,0), rgba(178,147,61,0.95), rgba(178,147,61,0.14))',
...
_s1(HowItWorks, "44iKIVWugz9Mcftgdl16pp1y8cY=", false, function() {
    return [
...
__turbopack_context__.k.register(_c, "DiamondMark");
__turbopack_context__.k.register(_c1, "TogglePill");
__turbopack_context__.k.register(_c2, "Tick");
__turbopack_context__.k.register(_c3, "StepMarker");
...
//# sourceMappingURL=_74a446ea._.js.map