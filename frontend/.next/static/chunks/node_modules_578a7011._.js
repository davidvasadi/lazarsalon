...
var ThreeSlippyMapGlobe = /*#__PURE__*/ function(_Group) {
    function ThreeSlippyMapGlobe(radius) {
        ...
        _this.add(_classPrivateFieldSet2(_innerBackLayer, _this, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SphereGeometry"](_classPrivateFieldGet2(_radius, _this) * 0.99, 180, 90), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshBasicMaterial"]({
            color: 0x0
        }))));
    ...
    return _createClass(ThreeSlippyMapGlobe, [
        ...
        },
        {
            ...
            value: function updatePov(camera) {
                var _this3 = this;
                if (!camera || !(camera instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Camera"])) return;
                ...
                _classPrivateFieldSet2(_isInView, this, function(d) {
                    ...
                    if (!frustum) {
                        frustum = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Frustum"]();
                        camera.updateMatrix();
                        camera.updateMatrixWorld();
                        frustum.setFromProjectionMatrix(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix4"]().multiplyMatrices(camera.projectionMatrix, camera.matrixWorldInverse));
                    }
                ...
                if (this.tileUrl) {
                    ...
                    var distToGlobeCenter = pov.distanceTo(this.getWorldPosition(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]()));
...
}(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Group"]);
...
function _fetchNeededTiles() {
  ...
  */ tiles.filter(function(d) {
        ...
        if (!d.obj) {
            ...
            var tile = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SphereGeometry"](_classPrivateFieldGet2(_radius, _this5), Math.ceil(width / _this5.curvatureResolution), Math.ceil(height / _this5.curvatureResolution), deg2Rad(90 - width / 2) + rotLng, deg2Rad(width), deg2Rad(90 - height / 2) + rotLat, deg2Rad(height)), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshLambertMaterial"]());
        ...
        if (!d.loading) {
            d.loading = true;
            // Fetch tile image
            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextureLoader"]().load(_this5.tileUrl(x, y, _this5.level), function(texture) {
                var tile = d.obj;
                if (tile) {
...
var THREE = typeof window !== 'undefined' && window.THREE ? window.THREE // Prefer consumption from global THREE, if exists
 : {
    ...
    Float32BufferAttribute: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Float32BufferAttribute"]
};
...
function geometry(type, coordinates) {
    let _options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    switch(type){
        case "Point":
...
function radiansToLength(radians) {
    let units = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "kilometers";
...
function convertLength(length) {
    let originalUnit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "kilometers", finalUnit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "kilometers";
    if (!(length >= 0)) {
...
function convertArea(area) {
    let originalUnit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "meters", finalUnit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "kilometers";
    if (!(area >= 0)) {
...
function geo_hull(triangles, points) {
    ...
    triangles.map((tri)=>{
        ...
        for(let i = 0; i < 3; i++){
            ...
            else _hull.add("".concat(e[1], "-").concat(e[0]));
        }
    });
...
//# sourceMappingURL=node_modules_578a7011._.js.map